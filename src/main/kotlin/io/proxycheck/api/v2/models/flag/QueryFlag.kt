...
enum class QueryFlag(val value: String) {
    ...
    /**
     * Enables detection exporting from the dashboard API.
     */
    EXPORT_DETECTIONS("export"),

    /**
     * Enables usage exporting from the dashboard API.
     */
    EXPORT_USAGE("usage"),

    /**
     * Enables custom lists support.
     */
    CUSTOM_LISTS("lists"),
    ...
    /**
     * Enables tag exporting from the dashboard API.
     */
    EXPORT_TAGS("tags");
